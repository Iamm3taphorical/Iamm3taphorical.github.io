...
export function MorphingCardStack({
    ...
    return (
        <div className={cn("space-y-4", className)}>
            {/* Layout Toggle */}
            <div className="flex items-center justify-center gap-1 rounded-lg bg-secondary/50 p-1 w-fit mx-auto backdrop-blur-sm">
                        ...
                        {displayCards.map((card) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={cn(
                                        "cursor-pointer rounded-xl border border-border bg-card/80 backdrop-blur-sm p-4",
